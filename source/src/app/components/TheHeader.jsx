                    ...
                    <nav className="header-nav">
                        <ul className="header-nav-list">
                            <li className="header-nav-list__item">
                                <a href="#" className="header-nav-list__link">Портфолио</a>
                            </li>
                            <li className="header-nav-list__item">
                                <a href="#" className="header-nav-list__link">Контакты</a>
                            </li>
                            <li className="header-nav-list__item">
                                <a href="#" className="header-nav-list__link">Услуги</a>
                            </li>
                            <li className="header-nav-list__item">
                                <a href="#" className="header-nav-list__link">Отзывы</a>
                            </li>
                            <li className="header-nav-list__item">
                                <a href="#" className="header-nav-list__link">О компании</a>
                            </li>
                        </ul>
                    </nav>
                    <div className="header__btns">
                        <button className="header__btn">Обсудить проект</button>
            ...
            <div className={mobMenu ? "header-mob header-mob_active" : "header-mob"}>
                <div className="header-mob__inner">
                    ...
                    <div className="header-mob__bottom">
                        ...
                        <button className="header-mob__btn">Обсудить проект</button>
                    </div>
